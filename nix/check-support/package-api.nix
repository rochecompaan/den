...
assert builtins.length adapter.adapter.closureOnlyPackages == 3;
assert toString (builtins.head adapter.adapter.closureOnlyPackages) == adapter.adapter.agent.executable;
assert adapter.adapter.passthru ? resourceDiagnostics;
assert builtins.elem adapter.adapter.passthru.resourceDiagnostics adapter.adapter.closureOnlyPackages;
assert builtins.length darwinAdapter.adapter.closureOnlyPackages == 4;
...
assert builtins.elem darwinAdapter.adapter.passthru.resourceDiagnostics darwinAdapter.adapter.closureOnlyPackages;
